            ...
            >
              <div className="relative aspect-[3/4] w-full bg-gray-800 overflow-hidden">
                {!hasError && coverImage ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-[10px] text-gray-400 text-center p-2 bg-gray-900/50">
                    <svg
          ...
          >
            ...
            <div className="mt-4 text-center">
              <span className="text-sm font-bold text-white">
                {selectedCover.volume === "Extra"
                  ? "Extra / Art"
                  : `Volumen ${selectedCover.volume}`}
              </span>
