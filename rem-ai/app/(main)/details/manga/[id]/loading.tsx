  ...
  return (
    <main className="bg-[#0b1120] min-h-screen text-white p-4 md:p-6 lg:p-8">
      <div className="max-w-[1200px] mx-auto flex flex-col gap-12 animate-pulse">
        ...
        {/* Esqueleto de la sección principal (MangaView) */}
        <div className="flex flex-col md:flex-row gap-8 bg-[#131b2e]/50 border border-white/5 p-6 rounded-3xl">
          {/* Portada fantasma */}
