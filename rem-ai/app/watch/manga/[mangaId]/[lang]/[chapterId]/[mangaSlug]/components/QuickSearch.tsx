    ...
    <div ref={containerRef} className="relative flex items-center gap-2">
      ...
      <div
        className={`flex items-center bg-[#151c2f] border rounded-xl transition-all duration-300 ease-in-out shadow-lg overflow-hidden ${
          isOpen 
            ? "w-60 sm:w-68 px-2.5 py-1.5 border-pink-500/50 opacity-100" 
        ...
        {!isOpen ? (
          ...
          <div className="flex items-center w-full relative gap-1.5 animate-fadeIn">
            ...
            <button
              ...
              className={`p-1 transition-colors ${searchQuery.trim() ? "text-pink-400 hover:text-pink-300 cursor-pointer" : "text-gray-600 cursor-default"}`}
