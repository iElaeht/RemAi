      ...
      <header className="relative h-screen flex items-center px-6 md:px-24">
        ...
        <div className="relative z-10 space-y-6 max-w-2xl mt-20">
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9]">
            Tu mundo <span className="text-red-500">Manga</span>.
          </h1>
          <p className="text-xl text-neutral-400 max-w-lg">
            Sumérgete en una biblioteca inteligente. Estética minimalista, carga
            instantánea y la mejor experiencia de lectura.
          </p>
        </div>
      </header>
