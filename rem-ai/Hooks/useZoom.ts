...
export const useZoom = () => {
  ...
  useEffect(() => {
    ...
    // ELIMINAMOS el listener de 'touchmove' que bloqueaba los gestos nativos.
    // Al quitarlo, el navegador recupera el control del pinch-to-zoom.
  ...
  return { isZoomed, setIsZoomed, offset, isTouch, handleInteraction, resetZoom };
};